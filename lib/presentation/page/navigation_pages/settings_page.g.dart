...
class SettingComponentsGen {
  ...
  static Map<String, String> themeSwitchValues(AppLocalizations i18n) =>
      <String, String>{
  ...
  static Map<String, String> colorSchemeValues(AppLocalizations i18n) =>
      <String, String>{
  ...
  static final settingsCustomizeLegacyColorSwitch = SettingComponent<bool>(
    ...
    description: (i18n) =>
        Text(i18n.settings_customize_legacy_color_switch_subtitle),
  );
  ...
  static Map<String, String> classesCardStyleValues(AppLocalizations i18n) =>
      <String, String>{
  ...
  static final classInspectorSwitch = SettingComponent<bool>(
    ...
    description: (i18n) =>
        Text(i18n.settings_classes_time_inspector_switch_subtitle),
  );
  ...
  static final dateInspectorSwitch = SettingComponent<bool>(
    ...
    description: (i18n) =>
        Text(i18n.settings_classes_date_inspector_switch_subtitle),
  );
  ...
  static Map<String, String> classDataSourceValues(AppLocalizations i18n) =>
      <String, String>{
  ...
  static Map<String, String> refreshFrequencyValues(AppLocalizations i18n) =>
      <String, String>{
  ...
  static final updateChecking = SettingComponent<bool>(
    ...
    description: (i18n) =>
        Text(i18n.settings_software_update_checking_switch_subtitle),
  );
}

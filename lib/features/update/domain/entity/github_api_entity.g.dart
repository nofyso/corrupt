...
GithubReleaseAssets _$GithubReleaseAssetsFromJson(Map<String, dynamic> json) => GithubReleaseAssets(
  json['url'] as String,
...
Map<String, dynamic> _$GithubReleaseAssetsToJson(GithubReleaseAssets instance) => <String, dynamic>{
  'url': instance.url,

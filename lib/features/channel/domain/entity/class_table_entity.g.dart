...
Map<String, dynamic> _$ClassEntityToJson(ClassEntity instance) => <String, dynamic>{
  'name': instance.name,
...
Map<String, dynamic> _$ClassTableToJson(ClassTable instance) => <String, dynamic>{
...
ClassTime _$ClassTimeFromJson(Map<String, dynamic> json) => ClassTime(
  (json['times'] as List<dynamic>)
      .map(
        (e) => _$recordConvert(
          e,
          ($jsonValue) => (($jsonValue[r'$1'] as num).toInt(), ($jsonValue[r'$2'] as num).toInt()),
        ),
      )
      .toList(),
);
...
Map<String, dynamic> _$ClassTimeToJson(ClassTime instance) => <String, dynamic>{
  'times': instance.times.map((e) => <String, dynamic>{r'$1': e.$1, r'$2': e.$2}).toList(),
};

$Rec _$recordConvert<$Rec>(Object? value, $Rec Function(Map) convert) =>
    convert(value as Map<String, dynamic>);

AvailableTermTime _$AvailableTermTimeFromJson(Map<String, dynamic> json) => AvailableTermTime(
...
Map<String, dynamic> _$AvailableTermTimeToJson(AvailableTermTime instance) => <String, dynamic>{
